...
public class CrmAutoTest {
    ...
    private static void newProject() throws InterruptedException {
        ...
        //Этот код отказывается выполняться. java: cannot access java.util.function. Function class file for java.util.function. Function not found
        /*WebDriverWait webDriverWait = new WebDriverWait(driver, 5);
        webDriverWait.until(ExpectedConditions.urlContains("my"));
        ...
        driver.findElement(By.xpath("//input[@name = 'crm_project[name]']")).sendKeys("Новый супер амбицозный проект");
    ...
    private static void newContactFace(){
        ...
        //Фамилия
        driver.findElement(By.name("crm_contact[lastName]")).sendKeys("Шальной");
        //Имя
        driver.findElement(By.name("crm_contact[firstName]")).sendKeys("Шишибар");
        //Организация
        driver.findElement(By.xpath("//span[text() = 'Укажите организацию']")).click();
        driver.findElement(By.xpath("//div[text() = '123test']")).click();
        //Должность
